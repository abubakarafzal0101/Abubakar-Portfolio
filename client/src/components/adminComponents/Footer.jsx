...
const Footer = () => {
  ...
  return (
    // Replaced slate with True Studio dark background and razor-sharp border lines
    <footer className="w-full h-12 bg-[#0F0F0F] border-t border-[#282828] px-4 md:px-8 flex items-center justify-between select-none z-40">
      {/* Left side: Copyright statement */}
      <span className="text-xs font-medium text-[#AAAAAA] tracking-wide">
